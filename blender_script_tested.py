...
bpy.ops.wm.obj_import(
    ...
    files=[{"name":"odm_textured_model_geo.obj", "name":"odm_textured_model_geo.obj"}], 
...
z_offset = 0.05 # added for visibility
...
for csv_i, csv_filepath in enumerate(list_csv_filepaths):
    ...
    curve_object = bpy.data.objects.new(f'polylineObject-{csv_filepath.stem}', curve_data)
    ...
    for p_i, (x, y, z) in enumerate(points):
        polyline.points[p_i].co = (x, y, z, 1)  # The last value is the weight of the data point
